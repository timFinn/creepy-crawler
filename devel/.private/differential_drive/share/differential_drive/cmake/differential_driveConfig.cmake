...
if("TRUE" STREQUAL "TRUE")
  set(differential_drive_SOURCE_PREFIX /home/robot/ROS/creepy_crawler/src/differential-drive)
  set(differential_drive_DEVEL_PREFIX /home/robot/ROS/creepy_crawler/devel/.private/differential_drive)
  ...
  set(differential_drive_INSTALL_PREFIX /home/robot/ROS/creepy_crawler/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/ROS/creepy_crawler/src/differential-drive/${idir}'.  Ask the maintainer 'Jon Stephan <jfstepha@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robot/ROS/creepy_crawler/devel/.private/differential_drive/lib;/home/robot/ROS/creepy_crawler/devel/lib;/opt/ros/kinetic/lib)
